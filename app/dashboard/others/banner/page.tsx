...
import { 
  ...
  ImageIcon, Eye, AlertCircle, FileSpreadsheet
} from "lucide-react";
...
export default function BannerPage() {
  ...
  // Explicitly typing the state array
  ...
  const exportBanners = () => {
    console.log("Exporting banners data...", banners);
            ...
            {isActionOpen && (
              <>
                ...
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-slate-100 z-50 py-2">
                  <button onClick={exportBanners} className="w-full flex items-center gap-3 px-4 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-50 transition-colors">
                ...
                <tr key={banner.id} className="group hover:bg-slate-50/80 transition-all duration-200">
                  ...
                  <td className="px-5 py-4">
                    <div className="flex justify-center">
                      <div className="relative w-14 h-14 bg-slate-100 rounded-xl overflow-hidden border border-slate-200 group-hover:border-blue-200 transition-all cursor-pointer">
