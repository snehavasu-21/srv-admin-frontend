...
//         <div>
//           <h1 className="text-3xl font-extrabold tracking-tight text-[#1B254B]">Manage Offer</h1>
//           <p className="text-slate-500 text-xs font-bold mt-1 uppercase tracking-widest italic">
//             SRV Electricals <span className="mx-2 text-slate-300">|</span> Promotional Campaigns
//           </p>
//         </div>
...
//                 <button onClick={exportOffers} className="w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold text-slate-600 hover:bg-blue-50 hover:text-blue-600 transition-colors">
//                   <FileSpreadsheet size={16} /> Export Offers
//                 </button>
...
//                 <th className="p-6 text-[10px] font-black uppercase tracking-[0.1em] text-slate-400">Offer Name</th>
//                 <th className="p-6 text-[10px] font-black uppercase tracking-[0.1em] text-slate-400 text-center">Offer Image</th>
...
//                   <td className="p-6">
//                     <span className="text-sm font-medium text-slate-400 tracking-tight">{offer.id}</span>
//                   </td>
                  
//                   <td className="p-6">
//                     <div className="font-bold text-[15px] text-[#1B254B] flex items-center gap-3">
...
//                       <div className="relative w-28 h-16 bg-slate-100 rounded-xl overflow-hidden border-2 border-white shadow-sm group-hover:border-[#4318FF]/20 transition-all">
//                          {/* Placeholder for your Diwali Banner Image */}
//                          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-orange-400 to-rose-500 text-white">
...
//                   <td className="p-6 text-center">
//                     <button className={`px-5 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-sm transition-all ${
...
//                        <button title="Edit Offer" className="p-3 bg-amber-400 text-white rounded-2xl shadow-md hover:scale-105 transition-all">
//                         <Edit2 size={16} />
//                       </button>
//                       <button title="Delete Offer" className="p-3 bg-[#EE5D50] text-white rounded-2xl shadow-md hover:scale-105 transition-all">
//                         <Trash2 size={16} />
//                       </button>
//                     </div>
//                   </td>
...
//              <AlertCircle size={14} /> 1 Offer Found
//            </p>
