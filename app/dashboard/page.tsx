...
//           const Icon = card.icon;
//           const cardClassName = `bg-white rounded-xl border border-slate-200 p-5 ${card.accent} ${card.hoverAccent} transition-all duration-200 ease-in-out hover:shadow-md hover:-translate-y-0.5 hover:bg-slate-50 cursor-pointer block`;
...
//           return card.href ? (
//             <Link key={i} href={card.href} className={cardClassName}>
//               {innerContent}
//             </Link>
//           ) : (
