  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans text-slate-700">
      ...
      <div className="max-w-5xl mx-auto flex items-center justify-between mb-8">
        ...
        <Link href="/dashboard/users/dealers" className="flex items-center gap-2 bg-white border border-slate-200 text-slate-600 px-4 py-2 rounded-lg text-sm font-semibold shadow-sm">
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-10">
        <form className="p-6 md:p-10 space-y-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
              <div className="space-y-1.5">
                ...
                <select className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500/20"><option>Dealers</option></select>
              </div>
              <div className="space-y-1.5">
          ...
          {/* Section 2: Location & Tracking (Full Grid) */}
          <section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <select className="w-full p-2.5 border border-slate-200 rounded-lg bg-white"><option>incomplete</option><option>verified</option></select>
                </div>
                <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 text-sm">
              ...
              <div className="space-y-1.5">
                ...
                <input type="text" disabled placeholder="Auto-generated" className="w-full p-2.5 bg-slate-100 border border-slate-200 rounded-lg text-slate-400" />
              </div>
              <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-3 pt-8 border-t border-slate-100">
            <button type="submit" className="flex items-center gap-2 bg-blue-600 text-white px-10 py-3 rounded-xl font-bold shadow-lg shadow-blue-100 active:scale-95 transition-all">
