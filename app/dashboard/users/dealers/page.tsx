...
//                 </th>
//                 {/* UPDATED: Titles are now font-black and text-slate-900 */}
...
//                     <div className="font-medium text-[#1B254B] text-sm">{dealer.name}</div>
...
//                     <div className="text-xs text-[#1B254B] font-medium">{dealer.phone}</div>
...
import {
  Search, Plus, FileDown, Eye, Edit2,
  Trash2, QrCode, ChevronLeft, ChevronRight,
  Filter, Building2, Wallet, CheckCircle2, AlertCircle,
} from "lucide-react";
...
export default function DealersPage() {
  ...
  const pendingCount = dealersData.filter((d) => d.status === "Pending").length;
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-6 md:p-8 font-sans">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
        <StatCard icon={Building2}    label="Total Dealers"  value={dealersData.length} iconBg="bg-indigo-100" iconColor="text-indigo-600" borderAccent="border-t-indigo-500" />
        <StatCard icon={CheckCircle2} label="Active"         value={activeCount}        iconBg="bg-green-100"  iconColor="text-green-600"  borderAccent="border-t-green-500" />
        <StatCard icon={AlertCircle}  label="Pending"        value={pendingCount}       iconBg="bg-amber-100"  iconColor="text-amber-600"  borderAccent="border-t-amber-500" />
        {/* <StatCard icon={Wallet}       label="Total Wallet"   value="₹10.6K"             iconBg="bg-blue-100"   iconColor="text-blue-600"   borderAccent="border-t-blue-500" /> */}
      </div>
